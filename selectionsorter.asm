#	This program reads in integers from a file named by `file`, does a selection sort on them, and then writes the sorted integers to the file named by `outf`.
# A custom-purpose itoa and atoi were necessary to complete this program.
#	This program does not utilize stack-stored variables, thanks to selection sort's simplicity.
