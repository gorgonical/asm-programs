	#	This program traverses a linked list provided by the file `file`, and writes the traversed list to the file `outf`.
	# The format of the linked list is: numbers at 0 and all odd positions indicate data, and numbers at all even positions indicate the next-node position for the node at the previous line.
	# When a -1 is found for the next-node number, this indicates the end of the linked list.
	# E.g.:
	#	4
	#	4
	#	3
